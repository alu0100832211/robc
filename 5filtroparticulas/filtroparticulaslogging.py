...
trayectreal = []
peso_medio_filtro = 0
# Generar filtro con centro aleatorio hasta que se encuentre una part�cula
# adecuada
...
logging.info("M�ximo peso medio del filtro: " + str(estadistica_maxPesoMedio))
